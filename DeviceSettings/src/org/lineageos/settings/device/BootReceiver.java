...
import org.lineageos.settings.device.cdm.Utils;
...
public class BootReceiver extends BroadcastReceiver implements Utils {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String rgbValue = Settings.Secure.getInt(context.getContentResolver(),
                Settings.Secure.DISPLAY_COLOR_BALANCE_RED, RED_DEFAULT) + " " +
                Settings.Secure.getInt(context.getContentResolver(), Settings.Secure.DISPLAY_COLOR_BALANCE_GREEN,
                        GREEN_DEFAULT) + " " +
                Settings.Secure.getInt(context.getContentResolver(), Settings.Secure.DISPLAY_COLOR_BALANCE_BLUE,
                        BLUE_DEFAULT);
        // Audio Gain
